...
import com.lucius.business.enums.HardwareInstallStatus;
import com.lucius.business.enums.NetWorkStatus;
...
@Entity
@Table(name = "ammeter_install_order")
@org.hibernate.annotations.Table(appliesTo = "ammeter_install_order", comment = "电表安装订单")
public class AmmeterInstallOrder extends BaseModel {
	...
	@OneToOne(mappedBy = "ammeterInstallOrder", fetch = FetchType.LAZY)
	...
	@OneToMany(mappedBy = "ammeterInstallOrder", cascade = { CascadeType.PERSIST, CascadeType.MERGE,
