...
@Entity
@Table(name = "router_install_order")
@org.hibernate.annotations.Table(appliesTo = "router_install_order", comment = "门锁安装订单")
public class RouterInstallOrder extends BaseModel {
	...
	@OneToOne(mappedBy = "routerInstallOrder", fetch = FetchType.LAZY)
	...
	@OneToMany(mappedBy = "routerInstallOrder", cascade = { CascadeType.PERSIST, CascadeType.MERGE,
